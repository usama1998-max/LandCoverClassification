...
img = cv2.imread("1499_sat.jpg", 0)

prev_img = cv2.imread("1499_sat.jpg")
...
_, thresholded1 = cv2.threshold(rimg, 119, 255, cv2.THRESH_BINARY_INV)
...
preview1[labels1 == 1] = (255, 0, 0)
preview1[labels1 == 2] = (0, 0, 255)
